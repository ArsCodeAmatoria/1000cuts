    ...
    <main id="main" className="flex-1">
      <section>
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 pb-8 pt-6 sm:gap-12 sm:px-6 sm:pb-10 sm:pt-10 lg:gap-14 lg:pb-12 lg:pt-14">
          <Reveal>
            <h1 className="grid w-full max-w-6xl grid-cols-[auto_minmax(0,1fr)] grid-rows-[auto_auto] items-start gap-x-4 gap-y-0 leading-none sm:gap-x-8 lg:gap-x-12">
              <span className="col-start-1 row-start-1 row-span-2 self-center font-sans text-[clamp(1.75rem,4.5vw,3rem)] font-medium tracking-tight text-foreground sm:pr-1">
                A
              </span>
              <span
                className={cn(
                  heroLogo.className,
                  "col-start-2 row-start-1 text-[clamp(3.75rem,17vw,11.5rem)] tracking-[-0.03em] text-foreground"
                )}
              >
                Thousand
              </span>
              <span
                className={cn(
                  heroLogo.className,
                  "col-start-2 row-start-2 -mt-[0.04em] text-[clamp(2.75rem,11vw,8rem)] tracking-[-0.02em] text-foreground sm:-mt-[0.06em]"
                )}
              >
                Cuts Films
              </span>
